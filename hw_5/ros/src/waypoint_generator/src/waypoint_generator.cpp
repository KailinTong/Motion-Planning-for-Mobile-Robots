...
void publish_waypoints_vis() {
    ...
    ROS_WARN("publish_waypoints_vis!");
...
//        cout << "position z: " << msg->pose.position.z << endl;               //NEW
//        cout << "waypoints.poses.size() " << waypoints.poses.size() << endl;  // NEW
        if (msg->pose.position.z > 0) {
